            ...
            steps {
                script {
                    ...
                    for (service in services) {
                        ...
                        sh "./mvnw clean install -pl ${service} -Dmaven.test.skip=true -P buildDocker -Ddocker.image.prefix=${env.DOCKER_USER} -Ddocker.image.tag=${imageName} -Dcontainer.build.extraarg=\"--push\""
